...
function openView(name, options = {}) {
  ...
  if (["contentlab","socialcard","publishing","analytics"].includes(name) && !PUBLISH_ROLES.has(user?.role)) name = "home";
