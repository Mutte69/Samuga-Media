...
(() => {
  ...
  function drawerMarkup() {
    ...
    return `
      ...
      <aside class="v3-drawer" id="v3Drawer" role="dialog" aria-modal="true" aria-label="Samuga Media menu" aria-hidden="true" tabindex="-1">
        ...
        <a class="v3-ai-drawer-btn" id="v3AskAi" href="/ask-samuga-ai"><span aria-hidden="true">✦</span><span data-v3-ai-label>Ask Samuga AI</span></a>
  ...
  function ensureChat() {
    if (document.body.classList.contains("ai-page") || document.body.dataset.floatingAi === "disabled") return;
  ...
  function bindGenericChat() {
    ...
    if (!fab || !panel || !form || !input || !messages || fab.dataset.chatBound === "true") return;
