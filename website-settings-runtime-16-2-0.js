...
(() => {
  ...
  function applyAI(s) {
    ...
    const isDedicatedAIPage = document.body.classList.contains("ai-page");
    const fab = $("#chatFab"), panel = $("#chatPanel"), drawerLink = $("#v3AskAi");
    if (fab && !isDedicatedAIPage) {
    ...
    if (panel && !isDedicatedAIPage && !enabled) {
  ...
  function applySettings(s) {
    ...
    document.documentElement.dataset.samugaSettings = "16.2.0";
