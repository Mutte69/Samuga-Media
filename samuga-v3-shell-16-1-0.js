...
(() => {
  ...
  const BUILD = "16.1.0-website-settings";
  ...
  function drawerMarkup() {
    ...
    return `
      ...
      <aside class="v3-drawer" id="v3Drawer" role="dialog" aria-modal="true" aria-label="Samuga Media menu" aria-hidden="true" tabindex="-1">
        ...
        <a class="v3-ai-drawer-btn" id="v3AskAi" href="/ask-samuga-ai.html"><span aria-hidden="true">✦</span><span data-v3-ai-label>Ask Samuga AI</span></a>
  ...
  function addDrawer() {
    ...
    bindCategories();
    bindNewsletterForms();
    q("#v3AskAi")?.addEventListener("click", closeDrawer);
  }
